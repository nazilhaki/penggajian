        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
                    <img src="assets/img/login-bg/bg-9.png" data-id="login-cover-image" alt="" />
                </div>
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-diamond text-success"></i>CV. ANGKUTAN AGUNG </h4>
                    <p>
                        Jl. Honoris Raya No.40 Kota Tangerang, Banten
                    </p>
                </div>
            </div>
            <!-- end news-feed -->
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class="logo"></span> WELCOME MATE !
                        <small> We Can Build Positive And Mutually Supportive Relationships</small>
                    </div>
                    <div class="icon">
